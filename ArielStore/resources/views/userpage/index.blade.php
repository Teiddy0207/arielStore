    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-4">
            <div class="flex justify-center items-center gap-2">
                ...
                <a href="{{ route('userpage.shirt') }}" class="text-black hover:underline">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-4">
            <div class="flex justify-center items-center gap-2">
                ...
                <a href="{{ route('userpage.pant') }}" class="text-black hover:underline">
                    <i class="fa-solid fa-arrow-right"></i>
                </a>
            </div>
        </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-4">
            <div class="flex justify-center items-center gap-2">
                ...
                <a href="{{ route('userpage.skirt') }}" class="text-black hover:underline">
                    <i class="fa-solid fa-arrow-right"></i>
                </a>
            </div>
        </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-4">
            <div class="flex justify-center items-center gap-2">
                ...
                <a href="{{ route('userpage.accessories') }}" class="text-black hover:underline">
                    <i class="fa-solid fa-arrow-right"></i>
                </a>
            </div>
        </div>
        ...
        <section class="mt-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Blog Card -->
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    <img src="LV.jpg" alt="Blog 1" class="w-full h-32 object-cover">
                    <div class="p-4">
                ...
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    <img src="lv.jpg" alt="Blog 2" class="w-full h-32 object-cover">
                    <div class="p-4">
                ...
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    <img src="lv.jpg" alt="Blog 3" class="w-full h-32 object-cover">
                    <div class="p-4">
