...
<main class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden relative">
            <!-- Product Image -->
            <img src="{{ asset('images/vayhela.png') }}" alt="Váy Hoa Vintage" class="w-full object-cover h-64">
            ...
            <div class="p-4">
                ...
                <div class="flex items-center justify-between mt-2">
                    <p class="text-black font-bold text-3xl">450,000đ</p>
                    <p class="text-gray-500 text-lg line-through">550,000đ</p>
                </div>
