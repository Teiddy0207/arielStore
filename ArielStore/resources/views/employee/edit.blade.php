                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('role') is-invalid @enderror" 
                            ...
                            <option value="Quản lý" {{ old('role', $employee->role) == 'Quản lý' ? 'selected' : '' }}>Quản lý</option>
                            <option value="Nhân viên bán hàng" {{ old('role', $employee->role) == 'Nhân viên bán hàng' ? 'selected' : '' }}>Nhân viên bán hàng</option>
                            <option value="Nhân viên kho" {{ old('role', $employee->role) == 'Nhân viên kho' ? 'selected' : '' }}>Nhân viên kho</option>
                        </select>
                        @error('role')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
